                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td >
                                <a v-bind:href="'/backend/product-categories/' + row.Id + '/edit'">
...
<script>
    export default {
        ...
        methods: {
            ...
            loadData: function (){
                $.getJSON('/api/product-categories-data', function (data) {
                    this.gridData = data;
            ...
            getData: function (request){
                ...
                switch (request){
                    ...
                    //     break;
                    case this.query :
                        getPage = '/api/product-categories-data?' +
                                  'keyword=' + this.query +
                                  '&column=' + this.sortKey +
                                  '&direction=' + this.sortOrder;
                        break;
            ...
            deleteItem: function(item){
                this.$http.delete('/backend/product-categories/'+item.Id).then((response) => {
                    // this.changePage(this.pagination.current_page);
                    // toastr.success('Item Deleted Successfully.', 'Success Alert', {timeOut: 5000});
                    this.doSuccess("刪除商品分類成功!");
                    this.getData();
