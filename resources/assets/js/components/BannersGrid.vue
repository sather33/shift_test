                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td >
                                <a v-bind:href="'/backend/banners/' + row.Id + '/edit'">
...
<script>
    export default {
        ...
        data: function () {
            return {
                query: '',
                gridColumns: ['Title', 'SubTitle', 'OpenDate', 'CloseDate', 'Order', 'Status', '上次編輯者', '上次編輯日期'],
                gridData: [],
                // total: null,
                // next_page_url: null,
                // prev_page_url: null,
        ...
        methods: {
            ...
            loadData: function (){
                $.getJSON('/api/banners-data', function (data) {
                    this.gridData = data;
            ...
            deleteItem: function(item){
                this.$http.delete('/backend/banners/'+item.Id).then((response) => {
                    // this.changePage(this.pagination.current_page);
                    // toastr.success('Item Deleted Successfully.', 'Success Alert', {timeOut: 5000});
                    this.doSuccess("刪除 Banner 成功!");
                    this.getData();
