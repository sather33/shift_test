                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            <td>
                                {{ row.Applied }} / {{ row.Quota }}<br>
                                <a v-bind:href="'/backend/activities/' + row.Id + '/applies'">
                            ...
                            <td >
                                <a v-bind:href="'/backend/activities/' + row.Id + '/edit'">
...
<script>
    export default {
        ...
        data: function () {
            return {
                query: '',
                gridColumns: ['標題', '副標題', '報名開始', '報名截止', '排序', '狀態', '上次編輯者', '上次編輯日期'],
                gridData: [],
                // total: null,
                // next_page_url: null,
                // prev_page_url: null,
        ...
        methods: {
            ...
            loadData: function (){
                $.getJSON('/api/activities-data', function (data) {
                    this.gridData = data;
            ...
            deleteItem: function(item){
                this.$http.delete('/backend/activities/'+item.Id).then((response) => {
                    // this.changePage(this.pagination.current_page);
                    // toastr.success('Item Deleted Successfully.', 'Success Alert', {timeOut: 5000});
                    this.doSuccess("刪除活動成功!");
                    this.getData();
