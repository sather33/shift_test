                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        <tr v-for="row in gridData">
                            ...
                            <td >
                                <a v-bind:href="'/backend/products/' + row.Id + '/edit'">
...
<script>
    export default {
        ...
        methods: {
            ...
            loadData: function (){
                $.getJSON('/api/backend-products-data', function (data) {
                    this.gridData = data;
            ...
            getData: function (request){
                ...
                switch (request){
                    ...
                    //     break;
                    case this.query :
                        getPage = '/api/backend-products-data?' +
                                  'keyword=' + this.query +
                                  '&column=' + this.sortKey +
                                  '&direction=' + this.sortOrder;
                        break;
            ...
            deleteItem: function(item){
                this.$http.delete('/backend/products/'+item.Id).then((response) => {
